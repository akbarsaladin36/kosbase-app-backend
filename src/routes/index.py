...
from src.routes.owner.index import router as owner_router
...
router.include_router(owner_router, prefix="/owner", dependencies=[Depends(user_role_required("owner"))])